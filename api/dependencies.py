...
def init_services():
    ...
    2. LLM client (verify API keys)
    3. Agent pipeline (wires everything together)
    """
    global _bundle, _agent, _llm_client
    ...
    logger.info(f"LLM providers available: {_llm_client.available_providers}")
